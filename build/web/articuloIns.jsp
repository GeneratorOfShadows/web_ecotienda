        ...
        <div class="container">
            ...
            <form action="Articulo" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" name="codigo" value="${articulos.codigo}" />
                </div > 
                <div class="mb-3">
                    <label  class="form-label">Nombre:  </label> 
                    <input class="form-control" type="text" name="nombre" value="${articulos.nombre}" />
                </div>
                <div class="mb-3">
                    <label  class="form-label">Precio: </label> 
                    <input class="form-control" type="number" name="precio" step="0.01" value="${articulos.precio}" />
                </div>
                <div class="mb-3">
                    <label  class="form-label">Cantidad: </label> 
                    <input class="form-control" type="number" name="cantidad" value="${articulos.cantidad}" />
                </div>
                <div class="mb-3">
                    <label  class="form-label">RUC del proveedor: </label> 
                    <select name="proveedor" class="form-control">
                        <c:forEach var="p" items="${proveedores}">                    
                            <option value="${p.id}">${p.ruc}</option>
                        </c:forEach>                
                    </select>
                </div>
