        ...
        <div class="container">
            ...
            <form action="Proveedor" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" name="ruc" value="${proveedor.ruc}" />
                </div>
                 <div class="mb-3">
                    <label  class="form-label">Direccion: </label> 
                    <input class="form-control" type="text" name="direccion" value="${proveedor.direccion}" />
                </div>
                 <div class="mb-3">
                ...
                <input class="btn btn-success"  type="submit" value="Insertar">   
                 <a type="button" class="btn btn-secondary" href="proveedor.jsp">Atras</a>
            </form> 
